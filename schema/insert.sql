...
insert into jaf values(1,1,'TestJaf1','Intern',10000,9.00,1,1,true);
insert into jaf values(2,2,'TestJaf2','Intern',10000,8.00,1,2,true);
...
insert into eligibility values(1,1,3);
insert into eligibility values(1,1,4);
insert into eligibility values(1,1,5);

insert into eligibility values(2,2,1);
insert into eligibility values(2,2,2);
insert into eligibility values(2,2,3);

insert into eligibility values(3,1,2);

insert into eligibility values(4,1,1);
insert into eligibility values(4,1,2);

insert into eligibility values(1,2,1);
insert into eligibility values(1,2,2);
insert into eligibility values(1,2,3);
